"""Internal model-trainer workflow values shared by delivery adapters."""
...
class TrainerCommand:
    """Internal request for one model lifecycle stage."""
...
class ModelTrainerConfiguration:
    """Resolved workflow inputs independent of environment-loading mechanics."""
    ...
    release_implementation_path: Path
    trainer_implementation_path: Path
    tracking_implementation_path: Path
    artifact_dir: Path
