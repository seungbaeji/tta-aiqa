...
class ModelTrainerSettings(BaseSettings):
    ...
    data_manifest_path: Path = Path(
        "docs/evidence/data-v2/data-manifest.json"
    )
    ...
    development_evidence_path: Path = Path(
        "docs/evidence/model-v1/development-benchmark.json"
    )
    feature_diagnostics_path: Path = Path(
        "docs/evidence/model-v1/feature-diagnostics.json"
    )
    ...
    bootstrap_evidence_path: Path = Path(
        "docs/evidence/model-v1/model-bootstrap.json"
    )
    freeze_manifest_path: Path
    release_manifest_path: Path = Path(
        "docs/evidence/model-v1/release-manifest.json"
    )
    canonical_evidence_path: Path = Path(
        "docs/evidence/model-v1/canonical-benchmark.json"
    )
