...
```bash
uv run python scripts/evidence/run_model.py development --revision v2
uv run python scripts/evidence/run_model.py diagnostics --revision v2
uv run python scripts/evidence/run_model.py bootstrap --revision v2
```
