...
| 실행 스크립트 | `01_check_container.sh` | container smoke test를 실행할 수 있는 선택 경로입니다 |
...
| GitOps path | `demos/ch03_docker_kubernetes/gitops/overlays/student` | Kustomize overlay를 통해 MLflow/KServe resource를 Argo CD가 반영할 경로입니다 |
| MLflow ingress patch | `demos/ch03_docker_kubernetes/gitops/overlays/student/ingress-host-patch.yaml` | 수강생 환경에 맞게 MLflow UI host를 수정해야 하는 파일입니다 |
