...
| 장 | Notebook | 역할 |
| --- | --- | --- |
| 1장 | `01_data_quality/pandas_data_quality_lab.ipynb` | 기준 데이터 품질 확인 |
| 2장 | `02_model_quality/model_evaluation_lab.ipynb` | 모델 지표와 threshold 해석 |
| 2장 | `02_model_quality/data_metric_connection_lab.ipynb` | 데이터 조건 변화와 지표 변화 연결 |
