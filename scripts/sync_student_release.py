...
from scripts.render_argocd_application import IN_CLUSTER_SERVER
from scripts.verify_target_release import RELEASES

ROOT = Path(__file__).resolve().parents[1]
ARGOCD_NAMESPACE = "argocd"
CANDIDATE_B_OVERLAY = "candidate-b"
CANDIDATE_B_PATH = f"deploy/kubernetes/overlays/{CANDIDATE_B_OVERLAY}"
