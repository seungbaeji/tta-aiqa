...
def add_output_arguments(
    ...
    *,
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="allow --output below docs/evidence after an explicit review",
    )
...
def resolve_output_path(
    *,
    ...
    historical_root = (root / "docs/evidence").resolve()
    if _is_within(resolved_output, historical_root) and not write_historical_evidence:
        raise ValueError(
            ...
            "docs/evidence or pass --write-historical-evidence explicitly"
        )
