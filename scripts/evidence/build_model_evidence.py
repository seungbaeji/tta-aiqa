...
def main() -> None:
    ...
    freeze_path = ROOT / "docs/evidence/model-v1/release-freeze.json"
    freeze = json.loads(freeze_path.read_text(encoding="utf-8"))
    frozen_paths = {
        "feature_contract_path": ROOT / "configs/contracts/model-input.yaml",
        "feature_sets_path": ROOT / "configs/model-v1/feature-sets.yaml",
        "profiles_path": ROOT / "configs/model-v1/profiles.yaml",
        "evaluation_path": ROOT / "configs/model-v1/evaluation.yaml",
        "release_policy_path": policy_path,
        "train_dataset": ROOT / "data/splits-v1/train.csv",
        "valid_dataset": ROOT / "data/splits-v1/valid.csv",
    ...
    document = {
        ...
        "sealed_test": {
            ...
            "freeze_manifest_path": "docs/evidence/model-v1/release-freeze.json",
        ...
        "configuration": {
            ...
            "profiles_sha256": sha256(ROOT / "configs/model-v1/profiles.yaml"),
            "evaluation_sha256": sha256(ROOT / "configs/model-v1/evaluation.yaml"),
