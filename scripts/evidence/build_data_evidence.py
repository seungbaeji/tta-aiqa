...
def parse_args() -> argparse.Namespace:
    ...
    add_output_arguments(
        parser,
        root=ROOT,
        default_relative_path="data-v2/data-manifest.json",
    )
...
def main() -> None:
    ...
    split_path = ROOT / "data/splits-v1/split-manifest.csv"
    ...
    document = {
        "schema_version": 1,
        "source": {
            "archive_sha256": sha256(ROOT / "data/raw-physionet/set-a.zip"),
            "outcomes_sha256": sha256(ROOT / "data/raw-physionet/Outcomes-a.txt"),
            "source_manifest_sha256": sha256(
                ROOT / "data/raw-physionet/source-manifest.yaml"
            ),
        },
        "configuration": {
