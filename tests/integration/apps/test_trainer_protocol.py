...
def finalized_settings(tmp_path: Path) -> ModelTrainerSettings:
    ...
    return ModelTrainerSettings(
        ...
        feature_sets_path=ROOT / "configs/model-v2/feature-sets.yaml",
        profiles_path=ROOT / "configs/model-v2/profiles.yaml",
        evaluation_path=ROOT / "configs/model-v2/evaluation.yaml",
        release_policy_path=ROOT / "configs/qa-v2.yaml",
