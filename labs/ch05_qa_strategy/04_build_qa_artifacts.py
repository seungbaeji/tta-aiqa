    ...
    return QAChecklist(
        items=(
            QAChecklistItem(
                ...
                owner="QA Lead",
                next_action="배포 판단 보고서에 label basis 유지 근거로 첨부",
            ),
            QAChecklistItem(
                section="입력 변화",
                text="입력 분포 변화 확인",
            ...
            QAChecklistItem(
                ...
                status="pass",
                evidence="release_approval.md",
                qa_comment="prepared_api_contract=True, live 확인 결과와 분리",
                owner="Platform/MLOps",
                next_action="live smoke 확인 결과와 혼동하지 않도록 보고서에 한정 표현",
            ),
            QAChecklistItem(
                section="서빙 품질",
                text="live 배포 확인 결과 확인",
                done=True,
                status="unverified",
                evidence="release_approval.md",
