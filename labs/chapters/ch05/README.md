...
uv run jupyter nbconvert --to notebook --execute \
  labs/chapters/ch05/00_compare_input_distributions.ipynb \
...
`docs/evidence/incident/prepared-observability-correlation.json`의
...
`deploy/k8s/rollback/`은 기준 모델로 돌아갈 설정을 선언할 뿐
