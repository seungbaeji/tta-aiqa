...
`artifacts/reports/release-decision-record.md`를 제출합니다. 최종 기록에는 확인한
범위, 근거 목록, 원인 후보, 모델 승인, 운영 배포 상태, 현재 권고, 승인, 보류
위험, 담당자와 재평가 조건이 있어야 합니다.
